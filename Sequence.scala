object Stmarks_seq {
  def main(args: Array[String]): Unit = {
    ...
    // Initializing a Sequence of student marks
    var Marks: Seq[StMarks] = Seq(
      StMarks("Faith", "F", 9, 11, 33)
    )

    // Adding more students to the Sequence
    Marks = Marks ++ Seq(
    ...
    // Printing the first item of the sequence
    println("The first element of the sequence is:")
    println("Head of Marks Sequence: " + Marks.head)

    // Printing all elements in the sequence
    println("All elements of the sequence:")
    ...
    println("Name and total marks for each student:")
