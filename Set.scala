object Stmarks_set {
  def main(args: Array[String]): Unit = {
    ...
    // Initializing a Set of student marks
    var Marks: Set[StMarks] = Set(
      StMarks("Faith", "F", 9, 11, 33)
    )

    // Adding more students to the Set (Immutable operation: creates a new Set)
    Marks = Marks ++ Set(
    ...
    // Printing the first item of the set
    println("The first element of the set is:")
    println("Head of Marks Set: " + Marks.head)

    // Printing all elements in the set
    println("All elements of the set:")
